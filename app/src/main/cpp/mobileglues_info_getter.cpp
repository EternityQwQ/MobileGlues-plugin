...
Java_com_fcl_plugin_mobileglues_eternity_MGInfoGetter_getMobileGluesGLInfo(JNIEnv *env,
                                                                          jobject thiz) {
...
Java_com_fcl_plugin_mobileglues_eternity_MGInfoGetter_setenv(JNIEnv *env, jobject thiz, jstring key,
